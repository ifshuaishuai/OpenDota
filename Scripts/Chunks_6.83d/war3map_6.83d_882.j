...
// 90993 ~ 91008
function Func4382 takes string loc_string01,unit loc_unit01,unit loc_unit02 returns nothing
    ...
    call SetTextTagColor(loc_texttag01,0,75,255,255)
    ...
    call SetTextTagLifespan(loc_texttag01,1.0)
